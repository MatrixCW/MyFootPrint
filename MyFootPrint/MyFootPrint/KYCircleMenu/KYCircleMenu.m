...
- (void)_updateButtonsLayoutWithTriangleHypotenuse:(CGFloat)triangleHypotenuse {
  ...
  switch (buttonCount_) {
    ...
    case 2: {
      ...
      [self _setButtonWithTag:3 origin:CGPointMake(positiveValue*2, 0)];
      [self _setButtonWithTag:3 origin:CGPointMake(negativeValue*2, 0)];
        break;
    }
    ...
    case 4: {
      CGFloat degree    = M_PI / 3.0f; // = 45 * M_PI / 180
      CGFloat triangleB = triangleHypotenuse * sinf(degree);
      CGFloat negativeValue = centerBallMenuHalfSize - triangleB - buttonRadius;
      CGFloat positiveValue = centerBallMenuHalfSize + triangleB - buttonRadius;
      [self _setButtonWithTag:1 origin:CGPointMake(negativeValue*4, negativeValue)];
      [self _setButtonWithTag:2 origin:CGPointMake(positiveValue*3/4, negativeValue)];
      [self _setButtonWithTag:3 origin:CGPointMake(negativeValue, positiveValue/2)];
      [self _setButtonWithTag:4 origin:CGPointMake(positiveValue, positiveValue/2)];
      break;
    }
